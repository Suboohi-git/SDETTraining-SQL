Select * from Suboohi_Activities.salesman;

update Suboohi_Activities.salesman set grade=100;
update Suboohi_Activities.salesman set grade=200 where city='Rome';
update Suboohi_Activities.salesman set grade=300 where name='James Hoog';
update Suboohi_Activities.salesman set name='Pierre' where name='McLyon';
